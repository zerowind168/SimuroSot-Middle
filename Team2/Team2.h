...
// from a DLL simpler. All files within this DLL are compiled with the TEAM2_EXPORTS
// symbol defined on the command line. this symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see 
// TEAM2_API functions as being imported from a DLL, wheras this DLL sees symbols
// defined with this macro as being exported.
#ifdef TEAM2_EXPORTS
#define TEAM2_API __declspec(dllexport)
#define STRATEGY_API __declspec(dllimport)
#else
#define TEAM2_API __declspec(dllimport)
...
typedef COPYDATASTRUCT REFERDATA;
/* MUST BE IMPLEMENTED */
extern "C" TEAM2_API void Create ( Environment *env );   
extern "C" TEAM2_API void Strategy ( Environment *env );
extern "C" TEAM2_API void Destroy ( Environment *env ); 
